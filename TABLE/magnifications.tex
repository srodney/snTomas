\begin{deluxetable*}{lccp{1.5in}p{2.2in}}
\tablecolumns{5}
...
\startdata
%Sharon         & 2.57$^{+0.19}_{-0.16}$ &   \citealt{Jullo:2007} \\[2mm]
...
Williams     & 2.67 & 2.78$^{+2.68}_{-1.14}$ &   \citealt{Liesenborgs:2006,Mohammed:2014} & {\tt GRALE}\tablenotemark{f} : Free-form strong-lensing model using a genetic algorithm.  \\
Merten       & 2.31 & 2.22$^{+0.67}_{-0.19}$ &   \citealt{Merten:2009,Merten:2011} &  SaWLENS, free-form strong+weak lensing based model.\\
Lam			 & \nodata & 2.77$^{+0.36}_{-0.36}$ &   \citealt{Sendra:2014,Lam:2014} & {\tt WSLAP+}\tablenotemark{g} : Free-form strong+weak lensing model using a grid-based method, supplemented by deflections fixed to cluster member galaxies.
\enddata
...
\tablenotetext{g}{{\tt GRALE} : }
\tablenotetext{f}{{\tt WSLAP+} : Weak and Strong Lensing Analysis Package plus member galaxies}
\end{deluxetable*}
