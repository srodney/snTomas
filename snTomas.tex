...
gravitational lenses is that most lensing reconstructions suffer from
the mass-sheet degeneracy \citep{Falco:1985,Bradac:2004}.  This
...
system has a projected position close to our SN sight-line.  It
happens that there is one such system, for which the position of a
multiple image near SN \tomas\ is presently disputed.  }
