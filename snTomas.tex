...
bias, \changeR{and reject explanations that
invoke} \changeP{misinterpretation of the SN data or errors in the
definition of the lens models}. \changeR{We conclude that -- at least for this
...
redshifts.}
\changeP{The {\it quality} of strong-lensing constraints is perhaps just as
...
the HFF program (Meneghetti et al. in prep), \changeP{using techniques
similar to \citet{Meneghetti:2010,Meneghetti:2014}}.  Preliminary
analysis of this simulation comparison suggests that
magnifications \change{can} be systematically overestimated for
sources that lie outside the strong-lensing region along the minor
axis direction of \changeR{ simulated clusters that are very
elongated, similar to Abell 2744.}  \changeP{This indicates that some
