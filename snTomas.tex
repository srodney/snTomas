...
\changeR{SN 2011fe had effectively no dust reddening \citep[e.g.][]{Nugent:2011,Li:2011c}, so the fact that SN 2011fe provides the best un-warped template match is further evidence that SN \tomas\ suffers from very little dust extinction.}
...
model (using GRALE) has the largest uncertainties, \changeR{with a
...
along the minor axis direction of \changeR{simulated clusters that are
very elongated, similar to Abell 2744. This finding would be
...
SN \tomas\ here indicates that such simulation efforts \changeR{and
