...
are {\it higher} than the measured value and \changeR{8} of these
...
and \changeR{find that model accuracy can be improved to some extent
by using multiply-imaged systems vetted with stringent quality cuts
and requiring that a large fraction of those systems have
...
not to generate overly small re-lensed
