...
this cluster and this line of sight -- the most accurate models are
those that employ stringent quality cuts for strong-lensing
constraints.} \change{A more robust evaluation of systematic biases
...
the full sample of \change{$\mu=2.5\pm0.4$.  This is separated from
...
the Williams model (using GRALE) has the largest uncertainties, in
part because it accounts for mass sheet degeneracy by introducing a
free parameter in the reconstruction that represents an arbitrarily
scaled mass sheet, with normalization to be chosen by the genetic
algorithm.  More complex degeneracies are also accounted for in this
model through the use of basis
...
bias.  \changeR{We first consider whether a misinterpretation of the data on the SN
...
Incorporating this
cosmological parameter uncertainty would increase the model magnification errors typically by 1-10\%. 
This would reduce the tension between models and observation, but would not
...
of \citet{Bayliss:2015}) would still leave the most extreme outlier
...
a common quality: they all use a set of multiply-imaged galaxies for
...
defined more stringently than other models. Some other models may use
...
redshifts.  The {\it quantity} of strong-lensing constraints is not as
important as their {\it quality}.
}
...
cluster lens models is through the use of simulated lensing data.  One can
