...
space more fully than parametric methods. 
...
better in the sense that they deliver more realistic uncertainties.
This may indicate that the free-form approach in general is more
successful in capturing the uncertainty from biases inherent to the
mass modeling exercise, such as the mass sheet degeneracy and more
complex ``approximate
invariances'' \citep{Liesenborgs:2012,Schneider:2014}.  }
