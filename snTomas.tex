...
variety of strong- and weak-lensing constraints. 
The models are collectively fairly accurate, with 3 that are
consistent within the 1$\sigma$ uncertainties.
% a naive unweighted mean of  $\mu_{\rm mod}=2.6$.  
...
degeneracies do not extend to the \citep{absolute} magnification of a
...
object and therefore has no impact on the SN classification or
...
six \change{so-called} {\it parametrized} models on top and the four
{\it free-form} models on the bottom.\footnote{\change{Although this
...
is assigned a mass or a potential, and then the grid spacing and the
mass values are iteratively refined to match the observed lensing
constraints.
...
it is far less than the 0.285 mag difference between the observed
