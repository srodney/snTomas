...
with that redshift, meaning that this spatially nearby galaxy is a background
...
$\sigma_c^+=0.54$, using the same distribution as for $x_1$.  The $c$ parameter in SALT2 combines intrinsic SN
...
\noindent The inferred magnifications for the two different fitters are reported in the final column of
...
GRALE(Williams?), which has the largest, and possibly the most realistic
...
for in GRALE(Williams?) through the use of basis
