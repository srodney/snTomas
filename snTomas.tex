...
this we determine the host galaxy mass to be $10^{10.1}$ \Msun. }
...
(Section~\ref{sec:HostGalaxy}) is below 10$^{10}$ \Msun. Note that
...
does not move the \tomas\ host mass above the mass step threshold, so
